...
<rect x="0" y="0" width="1025" height="1023" fill="rgba(0, 0, 0, 0)" />
    ...
    /* example2\src\subfolder\Icons1.svelte generated by Svelte v3.35.0 */
    const file$1 = "example2\\src\\subfolder\\Icons1.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = /*color*/ ctx[5];
    			option.value = option.__value;
    			add_location(option, file$1, 33, 6, 713);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	let div0;
    	let span0;
    	let raw0_value = icons$1["emojione:hear-no-evil-monkey"] + "";
    	let t5;
    	let span1;
    	let raw1_value = icons$1["emojione:speak-no-evil-monkey"] + "";
    	let t6;
    	let span2;
    	let raw2_value = icons$1["emojione:see-no-evil-monkey"] + "";
    	let t7;
    	let span3;
    	let raw3_value = icons$1["fa:random"] + "";
    	let t8;
    	let span4;
    	let raw4_value = icons$1["mdi:checkbox-multiple-marked"] + "";
    	let t9;
    	let span5;
    	let raw5_value = icons$1["ls:checkbox"] + "";
    	...
    	let div1;
    	let span6;
    	let raw6_value = icons$1["whh:checkboxalt"] + "";
    	let span6_style_value;
    	let t16;
    	let div2;
    	let span7;
    	let raw7_value = icons$1["icomoon-free:checkbox-checked"] + "";
    	let t17;
    	let span8;
    	let raw8_value = icons$1["mdi:format-list-checkbox"] + "";
    	let t18;
    	let span9;
    	let raw9_value = icons$1["mdi:checkbox-multiple-marked-circle"] + "";
    	let t19;
    	let span10;
    	let raw10_value = icons$1["clarity:checkbox-list-line"] + "";
    	let t20;
    	let span11;
    	let raw11_value = icons$1["ri:checkbox-circle-fill"] + "";
    	let t21;
    	let div3;
    	let h22;
    	let t23;
    	let html_tag;
    	let raw12_value = icons$1["emojione:hear-no-evil-monkey-wrong"] + "";
    	let t24;
    	let html_tag_1;
    	let raw13_value = icons$1["emojione-wrong:speak-no-evil-monkey"] + "";
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			t23 = space();
    			t24 = space();
    			add_location(h20, file$1, 29, 2, 570);
    			add_location(p, file$1, 30, 2, 607);
    			if (/*selected*/ ctx[0] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[3].call(select));
    			add_location(select, file$1, 31, 2, 646);
    			attr_dev(span0, "class", "size1 svelte-ehkg0e");
    			add_location(span0, file$1, 39, 4, 824);
    			attr_dev(span1, "class", "size1 svelte-ehkg0e");
    			add_location(span1, file$1, 42, 4, 916);
    			attr_dev(span2, "class", "size1 svelte-ehkg0e");
    			add_location(span2, file$1, 45, 4, 1009);
    			attr_dev(span3, "class", "size1 svelte-ehkg0e");
    			add_location(span3, file$1, 48, 4, 1100);
    			attr_dev(span4, "class", "size1 svelte-ehkg0e");
    			add_location(span4, file$1, 51, 4, 1173);
    			attr_dev(span5, "class", "size1 svelte-ehkg0e");
    			add_location(span5, file$1, 54, 4, 1265);
    			attr_dev(div0, "style", div0_style_value = "color:" + /*selected*/ ctx[0]);
    			add_location(div0, file$1, 37, 2, 783);
    			add_location(h21, file$1, 58, 2, 1348);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "20");
    			attr_dev(input, "max", "100");
    			add_location(input, file$1, 59, 2, 1384);
    			attr_dev(span6, "style", span6_style_value = "display: inline-flex; width: " + /*size*/ ctx[1] + "px !important;");
    			add_location(span6, file$1, 62, 4, 1468);
    			add_location(div1, file$1, 61, 2, 1457);
    			attr_dev(span7, "class", "size1 svelte-ehkg0e");
    			add_location(span7, file$1, 67, 4, 1618);
    			attr_dev(span8, "class", "size2 svelte-ehkg0e");
    			add_location(span8, file$1, 70, 4, 1711);
    			attr_dev(span9, "class", "size2 svelte-ehkg0e");
    			add_location(span9, file$1, 73, 4, 1799);
    			attr_dev(span10, "class", "size3 svelte-ehkg0e");
    			add_location(span10, file$1, 76, 4, 1898);
    			attr_dev(span11, "class", "size3 svelte-ehkg0e");
    			add_location(span11, file$1, 79, 4, 1988);
    			add_location(div2, file$1, 66, 2, 1607);
    			add_location(h22, file$1, 84, 4, 2094);
    			html_tag = new HtmlTag(t24);
    			html_tag_1 = new HtmlTag(null);
    			add_location(div3, file$1, 83, 2, 2083);
    			add_location(div4, file$1, 28, 0, 561);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ icons: icons$1, colors, selected, size });
...
<rect x="0" y="0" width="20" height="20" fill="rgba(0, 0, 0, 0)" />
    ...
    /* example2\src\Icons2.svelte generated by Svelte v3.35.0 */
    const file = "example2\\src\\Icons2.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	let div0;
    	let span0;
    	let raw0_value = icons["bx:bx-atom"] + "";
    	let t2;
    	let span1;
    	let raw1_value = icons["mdi:weather-pouring"] + "";
    	let t3;
    	let span2;
    	let raw2_value = icons["typcn:weather-stormy"] + "";
    	let t4;
    	let span3;
    	let raw3_value = icons["flat-ui:weather"] + "";
    	let t5;
    	let span4;
    	let raw4_value = icons["map:travel-agency"] + "";
    	let t6;
    	let span5;
    	let raw5_value = icons["zondicons:travel-bus"] + "";
    	let t7;
    	let span6;
    	let raw6_value = icons["ic:sharp-card-travel"] + "";
    	let t8;
    	let span7;
    	let raw7_value = icons["ls:checkbox"] + "";
    	let t9;
    	let span8;
    	let raw8_value = icons["emojione:sport-utility-vehicle"] + "";
    	let t10;
    	let span9;
    	let raw9_value = icons["ion:car-sport-sharp"] + "";
    	let t11;
    	let span10;
    	let raw10_value = icons["emojione-v1:sports-medal"] + "";
    	let t12;
    	let span11;
    	let raw11_value = icons["flat-color-icons:sports-mode"] + "";
    	let t13;
    	let span12;
    	let raw12_value = icons["jam:magic"] + "";
    	let t14;
    	let span13;
    	let raw13_value = icons["simple-line-icons:magic-wand"] + "";
    ...
    /* example2\src\App.svelte generated by Svelte v3.35.0 */
