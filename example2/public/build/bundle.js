    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file, 33, 6, 680);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t14 = space();
    			span13 = element("span");
    			add_location(h2, file$1, 14, 2, 209);
    			attr_dev(span0, "class", "size1 svelte-jxtdky");
    			add_location(span0, file$1, 17, 4, 262);
    			attr_dev(span1, "class", "size1 svelte-jxtdky");
    			add_location(span1, file$1, 20, 4, 333);
    			attr_dev(span2, "class", "size1 svelte-jxtdky");
    			add_location(span2, file$1, 23, 4, 413);
    			attr_dev(span3, "class", "size1 svelte-jxtdky");
    			add_location(span3, file$1, 26, 4, 494);
    			attr_dev(span4, "class", "size1 svelte-jxtdky");
    			add_location(span4, file$1, 29, 4, 570);
    			attr_dev(span5, "class", "size1 svelte-jxtdky");
    			add_location(span5, file$1, 32, 4, 648);
    			attr_dev(span6, "class", "size1 svelte-jxtdky");
    			add_location(span6, file$1, 35, 4, 729);
    			attr_dev(span7, "class", "size1 svelte-jxtdky");
    			add_location(span7, file$1, 38, 4, 810);
    			attr_dev(span8, "class", "size1 svelte-jxtdky");
    			add_location(span8, file$1, 41, 4, 882);
    			attr_dev(span9, "class", "size1 svelte-jxtdky");
    			add_location(span9, file$1, 44, 4, 973);
    			attr_dev(span10, "class", "size1 svelte-jxtdky");
    			add_location(span10, file$1, 47, 4, 1053);
    			attr_dev(span11, "class", "size1 svelte-jxtdky");
    			add_location(span11, file$1, 50, 4, 1138);
    			attr_dev(span12, "class", "size1 svelte-jxtdky");
    			add_location(span12, file$1, 53, 4, 1227);
    			attr_dev(span13, "class", "size1 svelte-jxtdky");
    			add_location(span13, file$1, 56, 4, 1297);
    			add_location(div0, file$1, 15, 2, 251);
    			add_location(div1, file$1, 13, 0, 201);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
