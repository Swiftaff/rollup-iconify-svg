    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			attr_dev(h1, "class", "svelte-xayb2x");
    			add_location(h1, file, 29, 2, 397);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 32, 4, 444);
    			add_location(p, file, 30, 2, 422);
    			html_tag = new HtmlTag(null);
    			attr_dev(main, "class", "svelte-xayb2x");
    			add_location(main, file, 28, 0, 388);
    		},
